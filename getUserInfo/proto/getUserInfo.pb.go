...
func (x *CallResponse) GetData() *UserData {
	if x != nil {
		return x.Data
	}
	return nil
...
func (x *ClientStreamRequest) Reset() {
	*x = ClientStreamRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_getUserInfo_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ClientStreamRequest) Descriptor() ([]byte, []int) {
	return file_proto_getUserInfo_proto_rawDescGZIP(), []int{2}
}
...
func (x *ClientStreamResponse) Reset() {
	*x = ClientStreamResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_getUserInfo_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ClientStreamResponse) Descriptor() ([]byte, []int) {
	return file_proto_getUserInfo_proto_rawDescGZIP(), []int{3}
}
...
func (x *ServerStreamRequest) Reset() {
	*x = ServerStreamRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_getUserInfo_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ServerStreamRequest) Descriptor() ([]byte, []int) {
	return file_proto_getUserInfo_proto_rawDescGZIP(), []int{4}
}
...
func (x *UserData) Reset() {
	*x = UserData{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_getUserInfo_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*UserData) Descriptor() ([]byte, []int) {
	return file_proto_getUserInfo_proto_rawDescGZIP(), []int{5}
}
...
func (x *ServerStreamResponse) Reset() {
	*x = ServerStreamResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_getUserInfo_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ServerStreamResponse) Descriptor() ([]byte, []int) {
	return file_proto_getUserInfo_proto_rawDescGZIP(), []int{6}
}
...
func (x *BidiStreamRequest) Reset() {
	*x = BidiStreamRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_getUserInfo_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*BidiStreamRequest) Descriptor() ([]byte, []int) {
	return file_proto_getUserInfo_proto_rawDescGZIP(), []int{7}
}
...
func (x *BidiStreamResponse) Reset() {
	*x = BidiStreamResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_getUserInfo_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*BidiStreamResponse) Descriptor() ([]byte, []int) {
	return file_proto_getUserInfo_proto_rawDescGZIP(), []int{8}
}
...
var file_proto_getUserInfo_proto_rawDesc = []byte{
	0x0a, 0x17, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x67, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x49,
	0x6e, 0x66, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0b, 0x67, 0x65, 0x74, 0x55, 0x73,
	0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0x21, 0x0a, 0x0b, 0x43, 0x61, 0x6c, 0x6c, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0x67, 0x0a, 0x0c, 0x43, 0x61, 0x6c,
	...
	0x06, 0x65, 0x72, 0x72, 0x6d, 0x73, 0x67, 0x12, 0x29, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x67, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x49,
	0x6e, 0x66, 0x6f, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x44, 0x61, 0x74, 0x61, 0x52, 0x04, 0x64, 0x61,
	0x74, 0x61, 0x22, 0x2d, 0x0a, 0x13, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x53, 0x74, 0x72, 0x65,
	...
	0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0xa4, 0x01, 0x0a,
	...
	0x55, 0x72, 0x6c, 0x22, 0x2c, 0x0a, 0x14, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x53, 0x74, 0x72,
	...
	,
	...
	,
}
...
var file_proto_getUserInfo_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_proto_getUserInfo_proto_goTypes = []interface{}{
	(*CallRequest)(nil),          // 0: getUserInfo.CallRequest
	(*CallResponse)(nil),         // 1: getUserInfo.CallResponse
	(*ClientStreamRequest)(nil),  // 2: getUserInfo.ClientStreamRequest
	(*ClientStreamResponse)(nil), // 3: getUserInfo.ClientStreamResponse
	(*ServerStreamRequest)(nil),  // 4: getUserInfo.ServerStreamRequest
	(*UserData)(nil),             // 5: getUserInfo.UserData
	(*ServerStreamResponse)(nil), // 6: getUserInfo.ServerStreamResponse
	(*BidiStreamRequest)(nil),    // 7: getUserInfo.BidiStreamRequest
	(*BidiStreamResponse)(nil),   // 8: getUserInfo.BidiStreamResponse
}
var file_proto_getUserInfo_proto_depIdxs = []int32{
	5, // 0: getUserInfo.CallResponse.data:type_name -> getUserInfo.UserData
	0, // 1: getUserInfo.GetUserInfo.Call:input_type -> getUserInfo.CallRequest
	2, // 2: getUserInfo.GetUserInfo.ClientStream:input_type -> getUserInfo.ClientStreamRequest
	4, // 3: getUserInfo.GetUserInfo.ServerStream:input_type -> getUserInfo.ServerStreamRequest
	7, // 4: getUserInfo.GetUserInfo.BidiStream:input_type -> getUserInfo.BidiStreamRequest
	1, // 5: getUserInfo.GetUserInfo.Call:output_type -> getUserInfo.CallResponse
	3, // 6: getUserInfo.GetUserInfo.ClientStream:output_type -> getUserInfo.ClientStreamResponse
	6, // 7: getUserInfo.GetUserInfo.ServerStream:output_type -> getUserInfo.ServerStreamResponse
	8, // 8: getUserInfo.GetUserInfo.BidiStream:output_type -> getUserInfo.BidiStreamResponse
...
func file_proto_getUserInfo_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_getUserInfo_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_getUserInfo_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_getUserInfo_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_getUserInfo_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_getUserInfo_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_getUserInfo_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_getUserInfo_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
